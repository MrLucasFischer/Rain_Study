...
Does gives us another usefull insight. A very humid day (80% or more) means that is more than likely to rain the following day, which might indicate that this feature might bbe useful. 
...
We've checked some of the features and found out visually that `RainToday`, `RainFall` and possibily `Humidity3pm` are good features to use in our machine learning model